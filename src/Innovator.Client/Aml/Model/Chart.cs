...
namespace Innovator.Client.Model
{
  ...
  public class Chart : Item
  {
    ...
    [ArasName("x_axis_value_label_style")]
    ...
    [ArasName("y_axis_value_label_style")]
