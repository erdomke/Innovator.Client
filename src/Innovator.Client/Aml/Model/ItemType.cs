...
namespace Innovator.Client.Model
{
  ...
  [ArasName("ItemType")]
  public class ItemType : Item, Irb_UserInputDataSource
  {
    protected ItemType() { }
    ...
    [ArasName("allow_private_permission")]
