...
namespace Innovator.Client.Model
{
  ...
  [ArasName("Property")]
  public class Property : Item, INullRelationship<ItemType>, IPropertyDefinition
  {
    protected Property() { }
