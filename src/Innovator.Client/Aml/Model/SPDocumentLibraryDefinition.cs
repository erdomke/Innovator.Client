...
namespace Innovator.Client.Model
{
  ...
  [ArasName("SPDocumentLibraryDefinition")]
  public class SPDocumentLibraryDefinition : Item
  {
    ...
    [ArasName("doc_type_label_plural")]
