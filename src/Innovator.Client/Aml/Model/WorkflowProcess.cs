...
namespace Innovator.Client.Model
{
  ...
  public class WorkflowProcess : Item
  {
    ...
    [ArasName("transition_line_color")]
    ...
    [ArasName("transition_name_color")]
