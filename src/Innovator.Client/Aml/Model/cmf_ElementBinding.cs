...
namespace Innovator.Client.Model
{
  ...
  public class cmf_ElementBinding : Item, INullRelationship<cmf_ElementType>
  {
    ...
    [ArasName("structure_mapping_method")]
    ...
    [ArasName("synchronization_direction")]
